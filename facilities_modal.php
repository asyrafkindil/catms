	  ...
	  <div class="modal-content">
        <div class="modal-header">
         ...
         <div class="modal-body">
                <div class="padd">
					<p>  1. Catering is within the area of Kuala Lumpur only.</p>

					<p>2. Additional 10% payment on reservation outside Klang Valley.</p>

					<p>3. MINIMUM Pax for Lunch & Dinner 50px , Drinks 30px and Non-Combo Combo meal is 30px.</p>
					...
					<p>7. 50% should be paid before the approval of reservation, 3 days without payments will resolve to the termination of reservation.</p>
				</div>
        </div>
